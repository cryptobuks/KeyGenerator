...
class YacoinKeypair(BitcoinKeypair):
    _pubkeyhash_version_byte = 77
    
class MaxcoinKeypair(BitcoinKeypair):
    _pubkeyhash_version_byte = 110
    
class MimicoinKeypair(BitcoinKeypair):
    _pubkeyhash_version_byte = 110
